...
const {get_title_url,w_error} = require(process.env.BIZ9_HOME + "/biz9-utility/code");
const biz9_config_file = require(path.join(__dirname, '../../biz9_config.js'));
const get_cache_connect_base = () => {
	return new Promise((callback) => {
		let error = null;
        let set_cache=false;
        let client_redis = redis.createClient(biz9_config_file.redis_port_id,biz9_config_file.redis_url);
