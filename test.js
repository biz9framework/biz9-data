    ...
    it("_connect", function(done){
        ...
        async.series([
            ...
            async function(call){
                ...
                //let option ={};
                let option = {get_distinct:true,distinct_field:'title',distinct_sort:'asc',get_join:true,field_key_list:[{primary_data_type:DataType.PRODUCT,primary_field:'category',item_field:'title',title:'my_product',type:Type.COUNT}]};
                ...
                const [biz_error,biz_data] = await Portal.search_new(database,search.data_type,search.filter,search.sort_by,search.page_current,search.page_size,option);
