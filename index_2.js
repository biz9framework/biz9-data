...
module.get_item_biz_list=function(db,data_type,sql,sort_by,page_current,page_size,option,callback){
    appz.get_item_biz_list(db,data_type,sql,sort_by,page_current,page_size,option,function(error,data_list,item_count,page_count)
        {
            callback(error,data_list,item_count,page_count);
        });
}
module.get_item_biz=function(db,data_type,key,option,callback){
    appz.get_item_biz(db,data_type,key,option,function(error,data)
        {
            callback(error,data);
        });
}
...
module.get_product=function(db,key,option,callback){
    appz.get_product(db,key,option,function(error,data)
        {
            callback(error,data);
        });
}
...
module.get_test_user = function(){
    return testz.get_test_user();
}
module.get_test_item = function(date_type,tbl_id){
    return testz.get_test_item(date_type,tbl_id);
}
module.get_test_sub_note=function(){
    return testz.get_test_sub_note();
}
module.get_test_note=function(){
    return testz.get_test_note();
}
//-- TEST END //
...
module.get_item_list_page_info=function(item_list,page_size){
    return appz.get_item_list_page_info(item_list,page_size);
}
//-- CATEGORY START //
...
module.get_category_item_count_list=function(db,data_type,sort_by,page_current,page_size,callback){
    appz.get_category_item_count_list(db,data_type,sort_by,page_current,page_size,function(error,data_list,item_count,page_count)
        {
            callback(error,data_list,item_count,page_count);
        });
}
...
module.get_eventz=function(db,sql,sort_by,page_current,page_size,callback){
    appz.get_item_list(db,DT_EVENT,sql,sort_by,page_current,page_size,function(error,data_list,item_count,page_count)
        {
            callback(error,data_list,item_count,page_count);
        });
}
module.get_servicez=function(db,sql,sort_by,page_current,page_size,callback){
    appz.get_item_list(db,DT_SERVICE,sql,sort_by,page_current,page_size,function(error,data_list,item_count,page_count)
        {
            callback(error,data_list,item_count,page_count);
        });
}
...
module.get_biz_optionz=function(db,sql,sort_by,page_current,page_size,callback){
    appz.get_item_biz_list(db,DT_OPTION,sql,sort_by,page_current,page_size,function(error,data_list,item_count,page_count)
        {
            callback(error,data_list,item_count,page_count);
        });
}
