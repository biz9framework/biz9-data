...
class List {
    static update = async (db_connect,item_data_list) => {
        return [error,data] = await update_item_list_adapter(db_connect,item_data_list);
    };
    static get = async (db_connect,data_type,filter,sort_by,page_current,page_size) => {
    ...
    static delete = async (db_connect,data_type,filter) => {
        return [error,data_list] = await delete_item_list_adapter(db_connect,data_type,filter);
    };
    static count = async (db_connect,data_type,filter) => {
